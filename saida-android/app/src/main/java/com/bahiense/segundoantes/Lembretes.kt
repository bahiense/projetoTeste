...
object Lembretes {
    ...
    fun notificar(ctx: Context) {
        ...
        val canal = NotificationChannel(
            CANAL, "Lembrete da noite", NotificationManager.IMPORTANCE_HIGH
        ).apply {
            description = "O aviso diário do exame da noite."
        }
        nm.createNotificationChannel(canal)

        val corpo = "Onde a corrente começou hoje? Confesse, agradeça, marque o dia."
        ...
        val n = Notification.Builder(ctx, CANAL)
            ...
            .setContentTitle("O exame da noite")
