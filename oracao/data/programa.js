/* =========================================================
   ...
   O `modo` diz ao app como montar o treino do dia:

     tema      sorteia um tema da lista
   ...
   Não há relógio em lugar nenhum: o exercício termina quando a
   oração termina. O que cresce ao longo dos 21 dias é a exigência
   — começar, desenvolver, conectar, aprofundar, conduzir —, não a
   duração. Quem mede oração pelo cronômetro está medindo a coisa
   errada.
   ========================================================= */
window.A = window.A || {};
...
A.PROGRAMA = [
    {
        ...
        instrucao: 'Escolha o tema e comece a orar em voz alta. Uma ideia, dita inteira — e pare.',
    ...
    },
    {
        ...
        instrucao: 'Antes de orar, responda mentalmente: "por que estamos orando agora?". Depois ore, sem se preocupar com o tamanho.',
    ...
    },
    {
        ...
        instrucao: 'Observe antes de falar: quem está aqui, o que está acontecendo, o que este momento precisa. Depois ore.',
    ...
    },
    {
        ...
        modo: 'frase', frase: 'Deus está conosco.',
        objetivo: 'Perceber quantas direções uma única ideia pode tomar.',
        instrucao: 'Explore esta única ideia: quem precisa lembrar disso hoje, onde isso aparece na realidade, do que precisamos por causa disso, o que isso revela sobre Deus, o que colocamos nas mãos dEle.',
        regra: 'Um assunto só. Não troque de tema quando a ideia parecer esgotada — faça a próxima pergunta.',
        reflexao: 'Consegui ficar na mesma ideia sem repetir a mesma frase?'
    },
    {
        dia: 5, fase: 1, titulo: 'Uma ponte', foco: 'Situação → Necessidade',
        modo: 'frase', frase: 'Senhor, estamos vivendo uma fase de incerteza...',
        objetivo: 'Sentir o momento em que a oração se move de um ponto para outro.',
        instrucao: 'Comece por essa frase e faça a ponte da situação para a necessidade. Continue enquanto houver algo verdadeiro a dizer.',
    ...
    },
    {
        ...
        modo: 'frase', frase: 'Senhor, ajuda minha família.',
        objetivo: 'Descobrir que um pedido simples contém muita profundidade.',
        instrucao: 'Antes de continuar, percorra: o que está acontecendo, o que isso está causando, do que realmente precisam, o que lembramos sobre Deus, o que entregamos. Depois ore.',
    ...
    },
    {
        ...
        modo: 'cenario', filtro: 'Família',
        objetivo: 'Juntar propósito, momento, desenvolvimento e profundidade sem anunciar o método.',
        instrucao: 'Sem preparação escrita: leia o momento e comece. Não tente demonstrar que está usando o método — apenas use.',
    ...
    },
    {
        ...
        modo: 'frase', frase: 'Deus cuida de nós.',
        objetivo: 'Expandir uma ideia sem repetir a mesma frase com palavras diferentes.',
        instrucao: 'Explore os cinco ângulos em voz alta, um de cada vez: pessoas, situações, necessidades, fé, entrega.',
    ...
    },
    {
        ...
        modo: 'frase', frase: 'Uma família está enfrentando uma decisão.',
    ...
    },
    {
        ...
        modo: 'frase', frase: 'Senhor, dá paz para essa pessoa.',
    ...
    {
        dia: 11, fase: 2, titulo: 'Ir até o fim do assunto', foco: 'ALTAR + Ângulos + Pontes',
        modo: 'frase', frase: 'Sabedoria para uma decisão.',
        objetivo: 'Ficar no mesmo assunto até esgotá-lo de verdade — avançando, não repetindo.',
        instrucao: 'Vá até onde a ideia der. Quando perceber que está repetindo, use uma ponte e avance para o próximo ângulo.',
        regra: 'Não repita a mesma ideia com outras palavras. Repetir é o sinal de que o assunto acabou — então avance ou encerre.',
        reflexao: 'Em quais momentos avancei? Em quais repeti em vez de avançar?'
    },
    {
        ...
        instrucao: 'Duas orações seguidas, mesma necessidade, contextos diferentes. Depois compare: o que mudou? O que permaneceu?',
    ...
    },
    {
        ...
        instrucao: 'Receba o tema e comece. Sem parar para montar a oração antes.',
        regra: 'Não peça tempo para pensar. O primeiro movimento já é o exercício.',
        reflexao: 'O que aconteceu na minha cabeça no instante antes da primeira palavra?'
    },
    {
        dia: 14, fase: 2, titulo: 'Segundo desafio', foco: 'Integração', desafio: true,
        modo: 'cenario', filtro: 'Célula',
        objetivo: 'Reunir desenvolvimento, conexão, profundidade e adaptação sem saber o que vem.',
        instrucao: 'Você não sabia que seria chamado. Leia o momento e conduza até o fim.',
    ...
    {
        dia: 15, fase: 3, titulo: 'Uma ideia só', foco: 'Brevidade com intenção',
        modo: 'cenario', filtro: 'Gratidão',
        objetivo: 'Aprender que oração curta não significa oração rasa.',
        instrucao: 'Uma única ideia, bem conectada ao momento, do começo à entrega. Nada além dela.',
        regra: 'Não corte no meio: uma ideia só, mas inteira, com conclusão.',
        reflexao: 'Minha oração soou intencional ou pareceu cortada?'
    },
    {
        dia: 16, fase: 3, titulo: 'Explorar o território inteiro', foco: 'Expandir sem repetir',
        modo: 'frase', frase: 'Famílias.',
        objetivo: 'Percorrer um assunto grande com ângulos, pontes e profundidade — sem repetição.',
        instrucao: 'Use os cinco ângulos, as quatro pontes e os cinco níveis — todos, sem anunciar nenhum. Só encerre quando tiver percorrido o assunto.',
        regra: 'Se perceber que está repetindo: ponte, próximo ângulo, ou desça um nível.',
        reflexao: 'Em que momento senti que estava preenchendo espaço? Em que momento avancei de verdade?'
    },
    {
        dia: 17, fase: 3, titulo: 'Contexto difícil', foco: 'Discrição',
        modo: 'cenario', filtro: 'Hospital',
        objetivo: 'Ser profundo sem ultrapassar aquilo que você realmente sabe.',
        instrucao: 'Antes de orar, lembre: não inventar, não especular, não expor. Depois ore.',
    ...
    },
    {
        ...
        instrucao: 'Contexto e necessidade são escolhidos por outra pessoa — aqui, pelo app. Você só descobre na hora. Comece.',
        regra: 'Não negocie o tema. O que veio, veio.',
    ...
    },
    {
        ...
        instrucao: 'Você está diante de um grupo. "Pode conduzir uma oração por este momento?" Leia o momento e conduza do começo ao fim.',
